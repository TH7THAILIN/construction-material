...
import { updateQuickView } from "@/app/redux/features/quickView-slice";
import { addItemToCart } from "@/app/redux/features/cart-slice";
import { addItemToWishlist } from "@/app/redux/features/wishlist-slice";
import { updateproductDetails } from "@/app/redux/features/product-details";
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] min-h-[270px] mb-4">
        <Image src={item.imgs?.previews?.[0] ?? "/images/placeholder.png"} alt="" width={250} height={250} />

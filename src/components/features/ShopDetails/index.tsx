...
import { usePreviewSlider } from "@/hooks/context/PreviewSliderContext";
            ...
            <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
              <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
                <div className="lg:max-w-[570px] w-full">
                  {isLoading ? (
                    <div className="lg:min-h-[512px] rounded-lg shadow-1 bg-gray-2 p-4 sm:p-7.5">
                      <Skeleton variant="rectangular" className="w-full h-full min-h-[400px]" />
                    </div>
                  ) : (
                  ...
                  {isLoading ? (
                    <div className="flex flex-wrap sm:flex-nowrap gap-4.5 mt-6">
                      {[...Array(4)].map((_, index) => (
                        <Skeleton key={index} variant="rectangular" className="w-15 sm:w-25 h-15 sm:h-25 rounded-lg" />
                      ))}
                    </div>
                  ) : (
                    <div className="flex flex-wrap sm:flex-nowrap gap-4.5 mt-6">
                  ...
                  {isLoading ? (
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <Skeleton variant="text" className="w-60 h-8" />
                      ...
                      <div className="flex flex-wrap items-center gap-5.5 mb-4.5">
                        <div className="flex items-center gap-2.5">
                          <div className="flex items-center gap-1">
                            {[...Array(5)].map((_, index) => (
                              <Skeleton key={index} variant="rectangular" className="w-4 h-4" />
                            ))}
                          </div>
                      ...
                      <div className="space-y-4 mb-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {[...Array(3)].map((_, index) => (
                            <Skeleton key={index} variant="rectangular" className="w-16 h-8 rounded" />
                          ))}
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-4">
                        <Skeleton variant="rectangular" className="w-32 h-12 rounded" />
                        <Skeleton variant="rectangular" className="w-40 h-12 rounded" />
                      </div>
                    </div>
                  ) : (
                    <>
